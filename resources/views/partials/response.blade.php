<div class="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-950 p-6">
    ...
    <div x-show="response && !response.error" class="space-y-4">
        ...
        <!-- Response Headers -->
        <details class="rounded bg-white dark:bg-gray-900 p-4 shadow dark:shadow-black/20">
            <summary class="cursor-pointer font-medium text-gray-700 dark:text-gray-300">Response Headers</summary>
            <div class="mt-3 space-y-1 text-sm font-mono">
                <template x-for="(value, key) in response.headers" :key="key">
                    <div class="border-t border-gray-200 dark:border-gray-700 py-1 pt-2">
                        <span class="font-medium text-gray-700 dark:text-gray-300" x-text="key + ':'" ></span>
                        <span class="text-gray-600 dark:text-gray-400" x-text="value"></span>
                    </div>
                </template>
            </div>
        </details>
